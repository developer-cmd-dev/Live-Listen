...
function Chat({handleRoomCreate,roomId}:Props) {
    ...
    return (
        <div className=' h-full max-w-full flex flex-col gap-2'>
            <div className='header h-15 flex  bg-neutral-800 rounded-xl'>
                <div className='h-full w-1/2 px-2 flex items-center text-sm'>
                    <p className='text-neutral-600 '>RoomId : {roomId}</p>
                </div>
                ...
                <div className='h-full w-1/2 px-2  flex items-center justify-end gap-5'>
                    ...
                    <Button onClick={handleRoomCreate} variant={'default'} title='exit'>
            ...
            <div className=' h-full w-full  flex flex-col'>
                <div className='h-full w-full flex flex-col-reverse overflow-y-auto gap-2'>
                    <div className='sender  min-h-10 max-h-fit w-full flex items-center justify-end'>
                        <div className="max-w-1/2 w-fit bg-[#155e75] p-3  rounded-2xl rounded-br-none" style={{ maxWidth: '50%' }}>
                            Messgage
                        </div>
                    </div>

                    <div className='reciever  min-h-10 max-h-fit w-full flex items-center justify-start'>
                        <div className="max-w-1/2  w-fit bg-[#155e75] p-3  rounded-2xl rounded-bl-none" style={{ maxWidth: '50%' }}>
                            <h1>Message</h1>
                        </div>
                    </div>
