...
import { googleAuthController, refreshToken } from "../controller/authentication.controller.js";
...
route.post("/auth/googleauth",googleAuthMiddleware,googleAuthController);
route.get("/", dashboard);
